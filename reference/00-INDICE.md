...
## Textos oficiais (verbatim, íntegros)

| Arquivo | O que é | Quando o editor abre |
|---|---|---|
| `edital-2026.md` | Edital FICC 2026 completo (Chamada Pública nº 003/2026) — condições, áreas, critérios de avaliação (item 12), acesso e acessibilidade (item 7), vedações | Toda revisão — critérios e regras gerais |
| `anexo-01-areas.md` | Anexo I — as 16 áreas: definições, modalidades, tetos por projeto, documentação complementar por área | Conferir área/modalidade/teto/elegibilidade da proposta |
| `anexo-02-inscricao.md` | Anexo II — checklist-mestre da documentação de INSCRIÇÃO | Conferir completude documental |
| `anexo-08-contratacao.md` | Anexo VIII — documentação de HABILITAÇÃO/CONTRATAÇÃO (pós-seleção) | Avisar o que vem depois da aprovação |
| `anexo-10-termo-execucao.md` | Anexo X — Termo de Execução Cultural (contrato): obrigações, punições, whitelist de despesas | Criticar orçamento e promessas que viram obrigação contratual |
| `anexo-13-cronograma.md` | Anexo XIII — cronograma das etapas do edital | Conferir prazos e fases |
| `anexos-formularios.md` | Anexos III, IV, V, VI, VII, IX, XI, XII — os formulários, campo a campo (VI e VII exaustivos) | Criticar preenchimento da Proposta (VI) e da Planilha (VII) |

## Camada digerida (navegação)
...
| `qa-plantao-oficial.md` | As respostas oficiais do plantão da Secretaria (anonimizadas, rastreáveis por data/hora); o total vive no cabeçalho do próprio arquivo, que é gerado | Quando o edital não fixa e a Secretaria interpretou — citar como interpretação do plantão, não como texto do edital |

## Hierarquia das fontes (em conflito)

1. Texto do edital e anexos (verbatim desta pasta) — a norma.
